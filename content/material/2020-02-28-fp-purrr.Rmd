...
> Source: These materials are *heavily* based on the book [*Functional Programming*](https://dcl-prog.stanford.edu/).
...
```{r, message=FALSE}
files <- paste0(url_folder, "/file_00", c("1.csv", "2.csv", "3.csv"))
files
...
you can easily implement parallel processing for your computationally complex analyses.
