...
> Note that while this format is 'messy' and not optimal for programatic analysis, i t may be a convenient, and less error prone, way of recording the data. That said, there is no excuse for the inconsistent column name seperator.
